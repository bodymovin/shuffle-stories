...
function buildPalette(colors:ColorSet) {
  return (
    <>
      <span className='palette__button__color' style={buildStyle(colors.color1)}></span>
      <span className='palette__button__color' style={buildStyle(colors.color2)}></span>
      <span className='palette__button__color' style={buildStyle(colors.color3)}></span>
    </>
  )
}
...
function Menu({colors}: MenuProps) {
